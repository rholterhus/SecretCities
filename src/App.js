  ...
  return (
    <>
      <div className="topbar">
        ...
        <Button size='small' variant='contained' onClick={toggleMapType} className={classes.suggestButton}>
          Suggest Location
        </Button>
      </div>
